      ...
      <section className="relative h-screen w-full overflow-hidden">
        {loading ? (
          <div className="flex items-center justify-center h-full">
            <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 dark:border-white border-blue-700"></div>
          </div>
        ) : (
          <>
            <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <div className="md:col-span-2 mb-2">
              <div className="sm:flex items-center mb-5">
                ...
                <h2 className="text-3xl font-bold sm:ml-2 text-background-secondary">
                  {t.home.title}
                </h2>
              </div>
              ...
              {t.home.paragraphs.map((paragraph, index) => (
                <p
                  key={index}
                  className="text-lg mb-6 text-black dark:text-gray-300"
                >
                  {paragraph}
                </p>
              ))}
              ...
              <h2 className="underline text-sky-700 dark:text-sky-500">
                {t.home.imageCaption}
              </h2>
            </div>
