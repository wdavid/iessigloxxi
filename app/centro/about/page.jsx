          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <div className="md:col-span-2 mb-2">
              <div className="sm:flex items-center mb-5">
                <h2 className="text-3xl font-bold text-background-secondary dark:text-blue-400">{t.about.title}</h2>
              </div>
              
              {/* Mapear cada párrafo en su propia línea */}
              {t.about.paragraphs.map((paragraph, index) => (
                <p key={index} className="text-lg mb-6 text-black sm:text-justify dark:text-gray-300">{paragraph}</p>
              ))}
            </div>
