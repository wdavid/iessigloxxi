      ...
      <div className={`sm:hidden ${isMobileMenuOpen ? "block" : "hidden"}`} id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <div>
            ...
            {dropdownOpen.centro && (
              <div className="pl-4">
                <Link href="/centro/about" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.quienesSomos}
                </Link>
                <Link href="/centro/organizacion" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.organizacion}
                </Link>
                <Link href="/centro/fp" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.fp}
                </Link>
                <Link href="/centro/eso" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.eso}
                </Link>
                <Link href="/centro/secretaria" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.secretaria}
                </Link>
              </div>
            )}
          ...
          <div>
            ...
            {dropdownOpen.documentacion && (
              <div className="pl-4">
                <Link href="/centro/programaciones" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.programaciones}
                </Link>
                <Link href="/centro/poyecto-educativo" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.proyectoEducativo}
                </Link>
                <Link href="/centro/plan-de-centro" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.planDeCentro}
                </Link>
          ...
          <div>
            ...
            {dropdownOpen.planes && (
              <div className="pl-4">
                <Link href="/centro/proa+transformate" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.PROAEmprendimiento}
                </Link>
                <Link href="/centro/aula-emprendimiento" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.auladeEmprendimiento}
                </Link>
                <Link href="/centro/bilinguismo" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.bilinguismo}
                </Link>
                <Link href="/centro/erasmus" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.erasmus}
                </Link>
                <Link href="/centro/comunidad-de-aprendizaje" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.comunidadaprendizaje}
                </Link>
                <Link href="/centro/mas-equidad" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.masequidad}
                </Link>
                <Link href="/centro/proa" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.proa}
                </Link>
                <Link href="/centro/biblioteca" className="block text-black dark:text-white px-3 py-2 hover:bg-background-secondary hover:text-white">
                  {t.biblioteca}
                </Link>
              </div>
            )}
